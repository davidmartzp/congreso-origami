...
export class WorkshopsFormComponent {
  ...
  initEditForm(workshop: Workshop) {
    const form = this.formBuilder.group({
      ...
      time: [workshop.time, Validators.required],
  ...
  getWorkshopImageUrl(imageName: string): string {
    ...
    return `https://origamibogota.com/congreso/storage/app/public/images/${imageName}`;
  }

  // Imagen por defecto en caso de error
  getDefaultImageUrl(): string {
    return 'https://origamibogota.com/congreso/storage/app/public/images/default.jpg';
  }
  ...
  createWorkshopFormGroup(): FormGroup {
    return this.formBuilder.group({
      ...
      time: ['1 Hora', Validators.required],
      observations: ['']
    });
  }
