...
<style>
    ...
    .custom-select {
        appearance: none;
        /* Para quitar los estilos predeterminados del select */
        padding: 8px 30px 8px 10px;
        /* Ajusta el padding según tu diseño */
        border: 1px solid #ccc;
        /* Puedes personalizar el borde */
        position: relative;
    ...
    .custom-select::after {
        ...
        /* Puedes cambiar el color de la flecha */
    }
...
<div class="card">
    ...
    <div>
        <button class="es btn btn-warning m-1">Español</button>
        <button class="en btn btn-warning m1">English</button>
    </div>
    <div class="instructions_es"><b>Instrucciones</b>:
        <ul>
            ...
            <li>Revisa los horarios en la lista de horarios, estos están configurados en función al menú <a target="_blank" href="https://origamibogota.com/descargas/Origami-Bogota-2024.pdf">(descarga aquí)<a> y busca el taller que quieras</li>
    ...
    <div class="instructions_en d-none"><b>Instructions</b>:
        <ul>
            ...
            <li>Check the schedule list for times, which are configured according to the menu <a target="_blank" href="https://origamibogota.com/descargas/Origami-Bogota-2024.pdf">(download here)</a> and find the workshop you want.</li>
    ...
    <div class="card-body cb2 d-none ">
        <div class="row mt-2 mb-2">
            <div class="col-md-6 text-center">
                <h3>Talleres | <span class="nameAssistant"></span></h3>

            </div>
            <div class="col-md-6">
                <!-- Botón para abrir el modal -->
                <button type="button" class="btn btn-primary btn-block float-end" onclick="openModal()">
                    Ver su selección
                </button>
            </div>
        </div>
        ...
        <div class="m-3">
            <label class="select-label instructions_es" for="horario">Despliega la lista con los horarios aquí abajo y selecciona un horario para escoger tus talleres :</label>
            ...
            @if(Carbon::now()->format('D') == 'Sat' || Carbon::now()->format('D') == 'Thu')
            <select id="horario" class="form-control custom-select">
        ...
        <div class="workshop-container">
            ...
            <div class="workshop {{ $w->day == 'S' ?  'children' : 'adults'}}  wschedule wschedule{{$w->schedule}} d-none">
                ...
                <div class="workshop-details">
                    ...
                    <span class="room">Salón: {{$w->assistantName == 'Dasa' ? 'Salón Especial' : $w->room }}</span><br>
                ...
                <div class="modal-body ">
                    ...
                    <table id=myTable class="table table-bordered">
                        ...
                        <tr class="taller{{$w->id}} taller d-none">
                            ...
                            <td>{{$w->name}} - Salón {{$w->assistantName == 'Dasa' ? 'Salón Especial' : $w->room }}</td>
                        </tr>
                        @endif
                        @endforeach
    ...
    <script>
        ...
        if (moment().format('ddd') == 'Sat' || moment().format('ddd') == 'Thu') {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.valid == true) {
                        ...
                        $(".nameAssistant").text(response.name)
