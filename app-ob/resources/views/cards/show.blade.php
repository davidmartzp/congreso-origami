                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-flex m-3">
                            <form method="GET" class="m-2" action="/confirm/{{$assistant->id}}"  role="form" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="1" name="status" id="status"/>
                                <button type="submit" class="btn btn-success">Confirmar asistente</button>
                            </form>

                            <form method="GET" class="m-2" action="/delay/{{$assistant->id}}"  role="form" enctype="multipart/form-data">
                                @csrf
