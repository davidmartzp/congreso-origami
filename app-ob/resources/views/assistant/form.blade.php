<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {!! Form::select('cards',["0"=>"NO","1"=>"SI"] , $assistant->cards, ['class' => 'form-control'. ($errors->has('cards') ? ' is-invalid' : '')]) !!}
        ...
        <div class="form-group">
            {{ Form::label('Días de asistencia') }}
            {!! Form::select('days',["T"=>"Todos","S"=>"Sábado","D"=>"Domingo"] , $assistant->days, ['class' => 'form-control'. ($errors->has('days') ? ' is-invalid' : '')]) !!}
            {!! $errors->first('Días de asistencia', '<div class="invalid-feedback">:message</div>') !!}
        </div>
