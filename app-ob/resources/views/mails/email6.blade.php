                            ...
                            <tr>
                                <td class="column">
                                    ...
                                    <table class="heading_block" role="presentation" width="100%">
                                        <tr>
                                            <td>
                                                <h3>📢 ¡Importante! Cambio de ubicación – Origami Bogotá 2025</h3>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="text_block" role="presentation" width="100%">
                                        <tr>
                                            <td>
                                                <p>Queremos informarles que, debido a cambios recientes en las políticas de la Universidad del Rosario —donde originalmente se iba a realizar el evento—, Origami Bogotá 2025 se llevará a cabo en una nueva ubicación:</p>
                                                <p><strong>📍 Nueva sede:<br>
                                                Liceo Francés Louis Pasteur<br>
                                                Cl. 87 #7-77, Barrio La Cabrera, Bogotá</strong></p>
                                                <p>Agradecemos mucho su comprensión y entusiasmo.<br>
                                                La buena noticia es que el Liceo Francés nos ha recibido con gran disposición, y todo está listo para que vivamos juntos un fin de semana lleno de creatividad y plegado. 🎋✨</p>
                                                <p>Si tienen alguna duda o necesitan ayuda para llegar, no duden en contactarnos.</p>
                                                <p>¡Nos vemos muy pronto!<br>
                                                Origami Bogotá 2025</p>
                                                <hr style="margin:32px 0;">
                                                <p><strong>Para estar al tanto de toda la información importante:</strong></p>
                                                <p>Puedes unirte a nuestro grupo de WhatsApp haciendo clic aquí:<br>
                                                    <a href="https://chat.whatsapp.com/DcH13ICGGOQ87dhQoDyC2s" target="_blank">Únete al Grupo de WhatsApp</a>
                                                </p>
                                                <p>Y agregar el evento a tu calendario aquí:<br>
                                                    <a href="https://calendar.app.google/gjo1rrSf7k6m8r5Q6" target="_blank">Agregar al Calendario</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
